...
ax1.set_title('Solar Powered CPy', fontsize = label_size + 1, fontweight = 'bold')
...
ax2.set_title('Continuous Powered CPy', fontsize = label_size + 1, fontweight = 'bold')
...
fig.savefig("cpy-soil-moisture-sensor.pdf", bbox_inches = 'tight')
